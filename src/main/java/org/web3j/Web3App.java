...
import org.web3j.generated.contracts.Token;
...
public class Web3App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*HelloWorld helloWorld1 = HelloWorld.load("", web3j, Credentials.create(""), new DefaultGasProvider());
        helloWorld1.greeting().send();
        web3j.shutdown();*/

        Token token = Token.load("", web3j, Credentials.create(""), new DefaultGasProvider());
        token.transferEventFlowable(DefaultBlockParameter.valueOf(BigInteger.ZERO), DefaultBlockParameter.valueOf("latest"))
                .subscribe(event -> handleEvent(event));

    }

    private static void handleEvent(Token.TransferEventResponse event) {
